...
;; Maintainer: Minoru Yamada <minorugh@gmail.com>
;; Version: 0.8.3
;; Package-Requires: ((emacs "24"))
;; Keywords: keyboard chord input
;; URL: https://github.com/minorugh/key-chord
...
;;         * Fork from LemonBreezes/key-chord (v0.8.2)
;;         * Updated Maintainer and URL for minorugh/key-chord
;;         * Added Version header for package-vc compatibility
;;         * Version 0.8.3
